...
// Wed Nov 30 17:25:56 2022 by ROOT version 6.26/04
// from TTree T/Hall A Analyzer Output DST
// found on file: e1209019_fullreplay_12037_stream0_seg10_10.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        bb_grinch_tdc_hit_amp[4];   //[Ndata.bb.grinch_tdc.hit.amp]
   Int_t           Ndata_bb_grinch_tdc_hit_col;
   Double_t        bb_grinch_tdc_hit_col[4];   //[Ndata.bb.grinch_tdc.hit.col]
   Int_t           Ndata_bb_grinch_tdc_hit_pmtnum;
   Double_t        bb_grinch_tdc_hit_pmtnum[4];   //[Ndata.bb.grinch_tdc.hit.pmtnum]
   Int_t           Ndata_bb_grinch_tdc_hit_row;
   Double_t        bb_grinch_tdc_hit_row[4];   //[Ndata.bb.grinch_tdc.hit.row]
   Int_t           Ndata_bb_grinch_tdc_hit_time;
   Double_t        bb_grinch_tdc_hit_time[4];   //[Ndata.bb.grinch_tdc.hit.time]
   Int_t           Ndata_bb_grinch_tdc_hit_xhit;
   Double_t        bb_grinch_tdc_hit_xhit[4];   //[Ndata.bb.grinch_tdc.hit.xhit]
   Int_t           Ndata_bb_grinch_tdc_hit_yhit;
   Double_t        bb_grinch_tdc_hit_yhit[4];   //[Ndata.bb.grinch_tdc.hit.yhit]
   ...
   Double_t        bb_ps_clus_atime[4];   //[Ndata.bb.ps.clus.atime]
   ...
   Double_t        sbs_hcal_clus_blk_atime[7];   //[Ndata.sbs.hcal.clus_blk.atime]
   Int_t           Ndata_sbs_hcal_clus_blk_col;
   Double_t        sbs_hcal_clus_blk_col[7];   //[Ndata.sbs.hcal.clus_blk.col]
   Int_t           Ndata_sbs_hcal_clus_blk_e;
   Double_t        sbs_hcal_clus_blk_e[7];   //[Ndata.sbs.hcal.clus_blk.e]
   Int_t           Ndata_sbs_hcal_clus_blk_e_c;
   Double_t        sbs_hcal_clus_blk_e_c[7];   //[Ndata.sbs.hcal.clus_blk.e_c]
   Int_t           Ndata_sbs_hcal_clus_blk_id;
   Double_t        sbs_hcal_clus_blk_id[7];   //[Ndata.sbs.hcal.clus_blk.id]
   Int_t           Ndata_sbs_hcal_clus_blk_row;
   Double_t        sbs_hcal_clus_blk_row[7];   //[Ndata.sbs.hcal.clus_blk.row]
   Int_t           Ndata_sbs_hcal_clus_blk_tdctime;
   Double_t        sbs_hcal_clus_blk_tdctime[7];   //[Ndata.sbs.hcal.clus_blk.tdctime]
   Int_t           Ndata_sbs_hcal_clus_blk_x;
   Double_t        sbs_hcal_clus_blk_x[7];   //[Ndata.sbs.hcal.clus_blk.x]
   Int_t           Ndata_sbs_hcal_clus_blk_y;
   Double_t        sbs_hcal_clus_blk_y[7];   //[Ndata.sbs.hcal.clus_blk.y]
 ...
 //THaEvent        *Event_Branch;
   ...
   TBranch        *b_SBSrb_dir_x;   //!
   TBranch        *b_SBSrb_dir_y;   //!
   TBranch        *b_SBSrb_dir_z;   //!
   TBranch        *b_SBSrb_e;   //!
   TBranch        *b_SBSrb_ok;   //!
   TBranch        *b_SBSrb_p;   //!
   TBranch        *b_SBSrb_ph;   //!
   ...
   TBranch        *b_SBSrb_th;   //!
   TBranch        *b_SBSrb_x;   //!
   TBranch        *b_SBSrb_xpos;   //!
   TBranch        *b_SBSrb_y;   //!
   TBranch        *b_SBSrb_ypos;   //!
   TBranch        *b_SBSrb_z;   //!
   TBranch        *b_SBSrb_zpos;   //!
...
#ifdef R_cxx
R::R(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("e1209019_fullreplay_12037_stream0_seg10_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("e1209019_fullreplay_12037_stream0_seg10_10.root");
      }
      f->GetObject("T",tree);
...
Int_t R::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R::LoadTree(Long64_t entry)
{
...
void R::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Lrb.dir.x", &Lrb_dir_x, &b_Lrb_dir_x);
   fChain->SetBranchAddress("Lrb.dir.y", &Lrb_dir_y, &b_Lrb_dir_y);
   fChain->SetBranchAddress("Lrb.dir.z", &Lrb_dir_z, &b_Lrb_dir_z);
   fChain->SetBranchAddress("Lrb.e", &Lrb_e, &b_Lrb_e);
   fChain->SetBranchAddress("Lrb.ok", &Lrb_ok, &b_Lrb_ok);
   fChain->SetBranchAddress("Lrb.p", &Lrb_p, &b_Lrb_p);
   fChain->SetBranchAddress("Lrb.ph", &Lrb_ph, &b_Lrb_ph);
   fChain->SetBranchAddress("Lrb.pol", &Lrb_pol, &b_Lrb_pol);
   fChain->SetBranchAddress("Lrb.px", &Lrb_px, &b_Lrb_px);
   fChain->SetBranchAddress("Lrb.py", &Lrb_py, &b_Lrb_py);
   fChain->SetBranchAddress("Lrb.pz", &Lrb_pz, &b_Lrb_pz);
   fChain->SetBranchAddress("Lrb.th", &Lrb_th, &b_Lrb_th);
   fChain->SetBranchAddress("Lrb.x", &Lrb_x, &b_Lrb_x);
   fChain->SetBranchAddress("Lrb.xpos", &Lrb_xpos, &b_Lrb_xpos);
   fChain->SetBranchAddress("Lrb.y", &Lrb_y, &b_Lrb_y);
   fChain->SetBranchAddress("Lrb.ypos", &Lrb_ypos, &b_Lrb_ypos);
   fChain->SetBranchAddress("Lrb.z", &Lrb_z, &b_Lrb_z);
   fChain->SetBranchAddress("Lrb.zpos", &Lrb_zpos, &b_Lrb_zpos);
   ...
   fChain->SetBranchAddress("SBSrb.dir.x", &SBSrb_dir_x, &b_SBSrb_dir_x);
   fChain->SetBranchAddress("SBSrb.dir.y", &SBSrb_dir_y, &b_SBSrb_dir_y);
   fChain->SetBranchAddress("SBSrb.dir.z", &SBSrb_dir_z, &b_SBSrb_dir_z);
   fChain->SetBranchAddress("SBSrb.e", &SBSrb_e, &b_SBSrb_e);
   fChain->SetBranchAddress("SBSrb.ok", &SBSrb_ok, &b_SBSrb_ok);
   fChain->SetBranchAddress("SBSrb.p", &SBSrb_p, &b_SBSrb_p);
   fChain->SetBranchAddress("SBSrb.ph", &SBSrb_ph, &b_SBSrb_ph);
   fChain->SetBranchAddress("SBSrb.pol", &SBSrb_pol, &b_SBSrb_pol);
   fChain->SetBranchAddress("SBSrb.px", &SBSrb_px, &b_SBSrb_px);
   fChain->SetBranchAddress("SBSrb.py", &SBSrb_py, &b_SBSrb_py);
   fChain->SetBranchAddress("SBSrb.pz", &SBSrb_pz, &b_SBSrb_pz);
   fChain->SetBranchAddress("SBSrb.th", &SBSrb_th, &b_SBSrb_th);
   fChain->SetBranchAddress("SBSrb.x", &SBSrb_x, &b_SBSrb_x);
   fChain->SetBranchAddress("SBSrb.xpos", &SBSrb_xpos, &b_SBSrb_xpos);
   fChain->SetBranchAddress("SBSrb.y", &SBSrb_y, &b_SBSrb_y);
   fChain->SetBranchAddress("SBSrb.ypos", &SBSrb_ypos, &b_SBSrb_ypos);
   fChain->SetBranchAddress("SBSrb.z", &SBSrb_z, &b_SBSrb_z);
   fChain->SetBranchAddress("SBSrb.zpos", &SBSrb_zpos, &b_SBSrb_zpos);
