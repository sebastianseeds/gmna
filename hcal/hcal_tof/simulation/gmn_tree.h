...
// Thu Jul 14 14:15:42 2022 by ROOT version 6.20/04
// from TTree T/Geant4 SBS Simulation
// found on file: gmn_3.5GeV2_elastic_TOF.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gmn_3.5GeV2_elastic_TOF.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gmn_3.5GeV2_elastic_TOF.root");
      }
      f->GetObject("T",tree);
